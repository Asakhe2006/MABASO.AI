...
export const footerLinkGroups = [
  ...
  },
  {
    title: "AI Tools",
    links: [
      { label: "Teacher Mode", route: "/ai-tools/teacher-mode" },
...
export const sitePages = [
  ...
  page({
    ...
    relatedPages: ["/product/formula-extraction", "/product/ai-test-generator", "/ai-tools/teacher-mode"],
    ...
    lockedPreview: {
      ...
      benefits: [
        ...
        "Move directly from examples into quizzes and Teacher Mode",
      ],
    },
  }),
  page({
    ...
    layout: [
      ...
      { title: "Cross-tool CTA strip", description: "Connect cards to tests, worked examples, and Teacher Mode." },
    ],
    modules: [
      {
        icon: "brain-circuit",
    ...
    relatedPages: ["/product/ai-study-guide", "/product/ai-test-generator", "/ai-tools/teacher-mode"],
  ...
  page({
    route: "/ai-tools/teacher-mode",
    title: "Teacher Mode",
    category: "AI Tools",
    access: "login",
    metadata: {
      title: "Teacher Mode | Mabaso AI",
      description: "AI spoken lessons, voice-based interruptions, pause and resume, and interactive lecture walkthroughs in Mabaso AI.",
    },
    hero: {
      eyebrow: "AI Tools / Teacher Mode",
      headline: "A spoken lesson mode that stays anchored to the study guide.",
      description: "Teacher Mode transforms the study guide into a paced spoken lesson with active section-following, pause and resume controls, and live student questions handled in context.",
      ctas: [
        primaryCta("Open Teacher Mode", "open-app", "workspace"),
        secondaryCta("View Study Guide", "route", "/product/ai-study-guide"),
      ],
      metrics: [
        { label: "Playback", value: "Voice-guided" },
        { label: "Questions", value: "Mid-lesson interrupts" },
        { label: "Guide sync", value: "Section aware" },
      ],
      preview: {
        kicker: "AI teacher interface",
        title: "Lesson playback, voice selection, and question capture",
        subtitle: "Use a calm audio-first visual with waveform cues, guide highlights, and an interactive question rail.",
        tabs: ["Lesson", "Voice", "Question", "Guide Sync"],
        rows: [
          { label: "Experience", value: "Audio + visual guide handoff" },
          { label: "Control", value: "Play, pause, resume, stop" },
          { label: "Protection", value: "Generated lessons require login" },
        ],
      },
    },
    contains: [
      { icon: "audio-waveform", title: "AI spoken lessons", description: "The page shows how text becomes paced lesson audio." },
      { icon: "message-square-more", title: "Interactive voice questions", description: "Students can interrupt the lesson, ask, and continue without losing place." },
      { icon: "map", title: "Guide-following playback", description: "Teacher Mode highlights the active guide section while the lesson runs." },
    ],
    layout: [
      { title: "Audio hero with section sync", description: "Lead with a teacher interface and a preview of the guide following the active segment." },
      { title: "Control and question section", description: "Explain playback states, voice options, and the interrupt-to-ask flow." },
      { title: "Cross-tool usage rail", description: "Connect Teacher Mode back to the guide, examples, and Study Chat." },
    ],
    modules: [
      {
        icon: "headphones",
        ...
        items: [
          ...
          "Voice selector and question state panel",
          "Live section-following guide preview",
        ],
      },
      {
        icon: "mic-2",
        title: "Question flow",
        items: [
          "Pause current lesson section",
          "Capture spoken question",
          "Answer in context and resume the lesson",
        ],
      },
      {
        icon: "lock-keyhole",
        title: "Access rules",
        items: [
          "Public page explains the AI lesson experience and shows a polished preview",
          "Generated teacher lessons, voice interactions, and active playback require login",
          "Blurred teacher controls appear behind the enterprise login wall when protected playback is requested without a session",
        ],
      },
    ],
    visuals: [
      "Audio waveform with guide-section highlight",
      "Voice and question control panel",
      "Interactive lesson timeline with active segment chip",
    ],
    emptyState: {
      title: "Teacher lesson not built yet",
      description: "Display a premium teacher card with a disabled waveform, inactive controls, and a CTA to generate the lesson from the workspace.",
    },
    designNotes: [
      "Teacher Mode should feel calm, reassuring, and premium rather than flashy.",
      "Use soft emerald accents for question-ready states and muted blue glows for playback.",
      "Keep the guide-following behavior visibly connected to the lesson shell.",
    ],
    ...
    lockedPreview: {
      title: "Interactive teacher lessons require sign-in",
      description: "The spoken lesson, saved playback state, and student question context are generated from your own protected lecture workspace.",
      benefits: [
        "Play a section-aware lesson from your study guide",
        "Ask questions without losing your place",
        "Resume Teacher Mode later from saved workspace history",
      ],
    },
  }),
  page({
    ...
    relatedPages: ["/ai-tools/teacher-mode", "/product/study-workspace", "/product/ai-study-guide"],
    footerCrossLinks: ["/support/help-center", "/company/security", "/company/privacy"],
    lockedPreview: {
  ...
  page({
    ...
    workflow: [
      ...
      "Use Teacher Mode, Study Chat, podcast, and presentation tools",
  ...
  page({
    ...
    hero: {
      ...
      metrics: [
        { label: "Issue intake", value: "Structured" },
        { label: "Public page", value: "Yes" },
        { label: "Secure submission", value: "Login recommended" },
      ],
      preview: {
    ...
    modules: [
      ...
      },
      {
        ...
        items: [
          ...
          "Actual secure ticket submission should encourage sign-in because messages often relate to workspace, uploads, or account-specific context",
          "Signed-out users should still see the form architecture with a premium secure-submission overlay",
        ],
      },
    ],
    visuals: [
    ...
    designNotes: [
      ...
      "Use form grouping, helper text, and quiet accent colors to reduce support friction.",
      "Secure-submission messaging should be clear without blocking public understanding of the process.",
    ],
    ...
    lockedPreview: {
      title: "Secure ticket submission works best with sign-in",
      description: "Many support cases involve lecture jobs, downloads, account state, or collaboration context. Signing in lets Mabaso AI route the ticket with the right account signals.",
      benefits: [
        "Attach account-safe context to support messages",
        "Reference your uploads, jobs, and workspace state",
        "Reach the right issue category faster",
      ],
    },
  }),
  page({
